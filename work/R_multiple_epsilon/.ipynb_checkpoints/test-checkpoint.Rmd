...
```{r}
dt_eps <- fread("/Users/erron_lipenglin/Desktop/Kyoko/trial_params.csv")
dt_gwd <- fread("/Users/erron_lipenglin/Desktop/Kyoko/trial_values.csv")
...
```{r}
# read npy file
ot_matrix <- as.matrix(npyLoad(paste0("/Users/erron_lipenglin/Desktop/Kyoko/npy/gw_",
                                   best_trial_id,".npy")))
